...
This "netlify" branch has been modified from the main branch so as to allow Netlify to deploy it. The modifications were required since this app uses Express, NodeJS (a backend server) to run.
